...
#ifndef HIVA_COMMON_GLOBAL_DATA_H_
#define HIVA_COMMON_GLOBAL_DATA_H_
...
using ::etron::hiva::proto::CyberConfig;
...
class GlobalData {
 ...
 private:
  ...
  // sched policy info
  std::string sched_name_ = "HIVA_DEFAULT";
...
#endif  // HIVA_COMMON_GLOBAL_DATA_H_
