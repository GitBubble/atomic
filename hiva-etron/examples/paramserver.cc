...
using etron::hiva::Parameter;
using etron::hiva::ParameterServer;
using etron::hiva::ParameterClient;

int main(int argc, char** argv) {
  etron::hiva::Init(*argv);
  std::shared_ptr<etron::hiva::Node> node =
      etron::hiva::CreateNode("parameter");
