...
#include "hiva/proto/record.pb.h"
#include "hiva/record/record_message.h"
#include "hiva/record/record_reader.h"
#include "hiva/record/record_writer.h"

using ::etron::hiva::record::RecordReader;
using ::etron::hiva::record::RecordWriter;
using ::etron::hiva::record::RecordMessage;
using etron::hiva::message::RawMessage;

const char CHANNEL_NAME_1[] = "/test/channel1";
const char CHANNEL_NAME_2[] = "/test/channel2";
const char MESSAGE_TYPE_1[] = "etron.hiva.proto.Test";
const char MESSAGE_TYPE_2[] = "etron.hiva.proto.Channel";
