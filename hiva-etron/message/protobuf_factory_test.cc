...
TEST(ProtobufFactory, register_and_generate) {
  ...
  etron::hiva::proto::ProtoDesc proto_desc;
  proto::UnitTest ut;
  ...
  get_desc_str.clear();
  factory->GetDescriptorString("etron.hiva.proto.UnitTest", &get_desc_str);
  EXPECT_EQ(get_desc_str, proto_desc_str);
  ...
  message = factory->GenerateMessageByType("etron.hiva.proto.UnitTest");
  ...
  desc_ptr = factory->FindMessageTypeByName("etron.hiva.proto.UnitTest");
