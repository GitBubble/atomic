...
#ifndef HIVA_MESSAGE_PY_MESSAGE_H_
#define HIVA_MESSAGE_PY_MESSAGE_H_
...
const char* const PY_MESSAGE_FULLNAME = "etron.hiva.message.PyMessage";
...
#endif  // HIVA_MESSAGE_PY_MESSAGE_H_
