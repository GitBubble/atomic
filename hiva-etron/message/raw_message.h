...
#ifndef HIVA_MESSAGE_RAW_MESSAGE_H_
#define HIVA_MESSAGE_RAW_MESSAGE_H_
...
struct RawMessage {
  ...
  static std::string TypeName() { return "etron.hiva.message.RawMessage"; }
...
#endif  // HIVA_MESSAGE_RAW_MESSAGE_H_
