...
#ifndef HIVA_SERVICE_DISCOVERY_CONTAINER_WAREHOUSE_BASE_H_
#define HIVA_SERVICE_DISCOVERY_CONTAINER_WAREHOUSE_BASE_H_
...
#endif  // HIVA_SERVICE_DISCOVERY_CONTAINER_WAREHOUSE_BASE_H_
