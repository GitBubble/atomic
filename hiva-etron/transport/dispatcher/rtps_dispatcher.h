...
#ifndef HIVA_TRANSPORT_DISPATCHER_RTPS_DISPATCHER_H_
#define HIVA_TRANSPORT_DISPATCHER_RTPS_DISPATCHER_H_
...
#endif  // HIVA_TRANSPORT_DISPATCHER_RTPS_DISPATCHER_H_
