...
#ifndef HIVA_TRANSPORT_RTPS_UNDERLAY_MESSAGE_TYPE_H_
#define HIVA_TRANSPORT_RTPS_UNDERLAY_MESSAGE_TYPE_H_
...
#endif  // HIVA_TRANSPORT_RTPS_UNDERLAY_MESSAGE_TYPE_H_
