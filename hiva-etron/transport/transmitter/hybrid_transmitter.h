...
#ifndef HIVA_TRANSPORT_TRANSMITTER_HYBRID_TRANSMITTER_H_
#define HIVA_TRANSPORT_TRANSMITTER_HYBRID_TRANSMITTER_H_
...
using etron::hiva::proto::OptionalMode;
using etron::hiva::proto::QosDurabilityPolicy;
using etron::hiva::proto::RoleAttributes;
...
#endif  // HIVA_TRANSPORT_TRANSMITTER_HYBRID_TRANSMITTER_H_
