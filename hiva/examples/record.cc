...
using ::apollo::hiva::record::RecordReader;
using ::apollo::hiva::record::RecordWriter;
using ::apollo::hiva::record::RecordMessage;
using apollo::hiva::message::RawMessage;

const char CHANNEL_NAME_1[] = "/test/channel1";
const char CHANNEL_NAME_2[] = "/test/channel2";
const char MESSAGE_TYPE_1[] = "apollo.hiva.proto.Test";
const char MESSAGE_TYPE_2[] = "apollo.hiva.proto.Channel";
