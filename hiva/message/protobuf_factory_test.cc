...
TEST(ProtobufFactory, register_and_generate) {
  ...
  apollo::hiva::proto::ProtoDesc proto_desc;
  proto::UnitTest ut;
  ...
  get_desc_str.clear();
  factory->GetDescriptorString("apollo.hiva.proto.UnitTest", &get_desc_str);
  EXPECT_EQ(get_desc_str, proto_desc_str);
  ...
  message = factory->GenerateMessageByType("apollo.hiva.proto.UnitTest");
  ...
  desc_ptr = factory->FindMessageTypeByName("apollo.hiva.proto.UnitTest");
